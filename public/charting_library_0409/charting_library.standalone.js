const TradingView = (function (t) {
  ...
  let o = !1;
  function s() {
    return 'CL v27.002 (internal id 18ee23e7 @ 2024-02-23T14:47:48.290Z)';
  }
  const r = class {
    constructor(t) {
      var i, s;
      ...
      'dark' ===
        ...
        this._options.debug &&
          (o ||
            ((o = !0),
            console.log(
              'Using CL v27.002 (internal id 18ee23e7 @ 2024-02-23T14:47:48.290Z)'
            ))),
        this._create();
    }
    setDebugMode(t) {
    ...
    _render(t) {
      ...
      const n = (function (t, e) {
        ...
        const o = new URL(`${t || ''}`, location.href).href,
          s = JSON.parse(
            '["bundles/runtime.08dc49106e20c7378783.js","bundles/__LANG__.4716.e4ac74dfc9ec5374b00c.js","bundles/6150.bda60280b05cea478076.css","bundles/5142.2c34c8656148cc5203b7.js","bundles/library.a970445029c5265cdaa4.js"]'
          ),
          ...
          l = `\n${(function (t, e, n) {
            ...
            for (const s of t)
              s.endsWith('.js')
                ? i.push(
                    `<script defer crossorigin="anonymous" src="${s.replace('__LANG__', n)}"><\/script>`
                  )
                : s.endsWith('.css') &&
                  o.push(
                    `<link type="text/css" href="${e ? s.replace(/\.css$/i, '.rtl.css') : s}" rel="stylesheet"/>`
                  );
            return [...i, ...o].join('\n');
          })(s, 'rtl' === a.dir, r)}\n`;
